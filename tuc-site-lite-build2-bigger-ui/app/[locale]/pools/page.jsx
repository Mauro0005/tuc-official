        ...
        <table className="w-full table-auto border-collapse min-w-[720px] text-[15px]">
          <thead>
            <tr className="border-b border-black/10 dark:border-white/10 bg-white/50 dark:bg-white/5">
              <th className="w-[6%] px-1.5 py-1.5 text-left font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
              <th className="w-[40%] px-1.5 py-1.5 text-left font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
              <th className="w-[11%] px-1.5 py-1.5 text-right font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
              <th className="w-[11%] px-1.5 py-1.5 text-right font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
              <th className="w-[11%] px-1.5 py-1.5 text-right font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
              <th className="w-[11%] px-1.5 py-1.5 text-right font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
              <th className="w-[10%] px-1.5 py-1.5 text-right font-semibold text-black/80 dark:text-white/80 text-[15px]">\1</th>
            </tr>
          </thead>
          <tbody>
            {teams.map((code, idx)=>(
              <tr key={code} className="hover:bg-black/5 dark:hover:bg-white/5">
                <td className="px-1.5 py-1.5 text-left font-mono text-base">{idx+1}.</td>
