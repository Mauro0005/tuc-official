...
export default function Navbar({ locale = "nl" }) {
  ...
  return (
    <nav className="navbar-vibrant sticky top-0 z-50 border-b border-black/10 dark:border-white/10 bg-white/75 dark:bg-black/70 backdrop-blur pt-[env(safe-area-inset-top)]">
