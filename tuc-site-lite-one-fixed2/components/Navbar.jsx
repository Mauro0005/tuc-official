...
export default function Navbar({ locale='nl' }){
  ...
  const t = locale==='nl'
    ? {home:'Home', schedule:'Speelschema', rules:'Regels', teams:'Teams', location:'Locatie', partners:'Partners', media:'Media', contact:'Contact'}
    : {home:'Home', schedule:'Schedule', rules:'Rules', teams:'Teams', location:'Location', partners:'Partners', media:'Media', contact:'Contact'};

  return (
    <nav className="sticky top-0 z-40 border-b border-black/10 dark:border-white/10 bg-white/70 dark:bg-black/70 backdrop-blur">
      <div className="container flex items-center justify-between py-3">
        <Link href={'/'+locale} className="flex items-center gap-2">
          <img src="/logo.png" alt="TUC" className="h-8 w-auto" />
          <span className="font-bold">TUC</span>
        </Link>
